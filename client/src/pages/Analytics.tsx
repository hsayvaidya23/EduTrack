...
const Analytics = () => {
    const [analyticsType, setAnalyticsType] = useState<'financial' | 'class'>('financial'); // Main option
                ...
                {analyticsType === 'financial' ? (
                    <>
                        ...
                        <div className="grid gap-6 grid-cols-1 xl:grid-cols-2 2xl:grid-cols-2">
                            <Card className="w-full">
                                <CardHeader>
                                    <CardTitle className="text-lg md:text-xl">Financial Analytics <span className='text-gray-700'> (Expenses vs Income)</span></CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <ChartContainer
                                        config={{
                    ...
                    <div>
                        {/* Placeholder for Class Analytics */}
                        <Card className="w-full">
                            <CardHeader>
